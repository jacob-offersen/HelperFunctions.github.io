...
function setup() {
    ...
    vinInput.attribute('placeholder', '0');
    ...
    r1Input.attribute('placeholder', '0');

    r1TolInput = createInput();
    ...
    r2Input.attribute('placeholder', '0');

    r2TolInput = createInput();
    ...
    r2TolInput.attribute('placeholder', '0');
}
...
function draw() {
    ...
    let voutMax = 0;
    if (vin > 0 && r1 > 0 && r2 > 0) {
        voutAvg = vin * (r2 / (r1 + r2));
        voutMin = voutAvg;
        voutMax = voutAvg;
        if (r1Tol > 0 && r2Tol > 0) {
            voutMin = vin * (r2Min / (r1Max + r2Min));
            voutMax = vin * (r2Max / (r1Min + r2Max));
        }
    }
